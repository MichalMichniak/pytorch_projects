...
class CNN_cifar10:
    def __init__(self) -> None:
        self.conv1 = torch.nn.Conv2d(3,18,5) # 18 chanels 28x28
        self.poling1 = torch.nn.AvgPool2d(2,2) # 18 chanels 14x14
        self.conv2 = torch.nn.Conv2d(18,28,5) # 28 channels 10x10
        self.poling2 = torch.nn.AvgPool2d(2,2) # 28 channels 5x5
        self.conv3 = torch.nn.Conv2d(28,32,3) # 32 channels 3x3
        self.flatten1 = torch.nn.Flatten(-3,2) # 288
        self.FC1 = torch.nn.Linear(288, 60)
        self.FC2 = torch.nn.Linear(60, 20)
        self.FC3 = torch.nn.Linear(20,12)
